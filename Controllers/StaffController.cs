...
namespace SieuThi.Controllers
{
    public class StaffController : Controller
    {
        ...
        public StaffController(MartContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Manv,Tennv,Luong,Ca,MotaCV")] Staff staff)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Manv,Tennv,Luong,Ca,MotaCV")] Staff staff)
        {
            if (id != staff.Manv)
            {
                return NotFound();
